...
(define (part-1 input)
  (for/fold ([invalid-ids-sum 0]) ([an-id-range (in-list input)])
    (match-define (id-range min-bound max-bound) an-id-range)
    (+ invalid-ids-sum
       (for/fold ([sum 0]) ([number (in-inclusive-range min-bound max-bound)])
...
(module+ test
  (check part-1
         ...
         `(1227775554 ,(string-join '("11-22" "95-115"
                                              "998-1012"
  ...
  (check part-2
         ...
         `(4174379265 ,(string-join '("11-22" "95-115"
                                              "998-1012"
                                              "1188511880-1188511890"
                                              "222220-222224"
                                              "1698522-1698528"
